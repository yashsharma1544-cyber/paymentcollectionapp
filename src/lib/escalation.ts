...
export function getTemplateName(level: EscalationLevel): string | null {
  switch (level) {
    ...
    case "visit": return "payment_alert";
    case "final": return "payment_alert";
...
export const APPROVED_TEMPLATES = [
  { name: "payment_alert", label: "🚨 Payment Alert", description: "Payment reminder with outstanding details" },
] as const;
